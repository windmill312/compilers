package com.windmill312.compiler;

import com.windmill312.Application;
...
public class PythonEvaluator extends PythonBaseListener {
    private static final String RESOURCES_PATH = "src/main/resources/application.properties";
    public PythonParser parser;
    private ParseTreeProperty<HashMap<String, ArrayList<String>>> idMap;
    private ParseTreeProperty<ArrayList<ArrayList<String>>> comp_forMap;
    private ParseTreeProperty<HashMap<String, ArrayList<String>>> forNameIdMap;
    private Stack<String> globalTestList;
    private String[] tokenTable = new String[100];
    private ArrayList<String> importedNames;
    private ArrayList<String> functionNames;
    private ArrayList<String> importDottedNames;
    private HashMap<String, ArrayList<String>> globalIdsMap;
    private ParseTreeProperty<ArrayList<Token>> ruleTokens;

    public PythonEvaluator(PythonParser parser) {
        ...
        try {
            ...
            FileReader tsteam = new FileReader(prop.getProperty("compiler-path") + "Python.tokens");
            ...
            tsteam = new FileReader(prop.getProperty("samples-path") + Application.SCRIPT);
            StringBuilder text = new StringBuilder();
            int i;
            while ((i = tsteam.read()) != -1)
                text.append((char) i);
            PythonInterpreter python = new PythonInterpreter();
            OutputStream stream = new ByteArrayOutputStream();
            python.setErr(stream);
            try {
                python.exec(text.toString());
